  ...
  return (
    <section className="bg-[#f7f7f7] py-20 px-6 md:px-16 lg:px-24">
      ...
      <div className="text-center max-w-4xl mx-auto mb-20">
        ...
        <h2 className="text-4xl md:text-5xl font-[400] text-[#000000] mb-6 font-raleway">
          Building Spaces that last
        </h2>

        <p className="text-[#6B6B6B] text-2xl leading-relaxed font-poppins">
        ...
        {storyData.map((item) => (
          ...
          >
            ...
            <div>
              ...
              <p className="text-[#6B6B6B] leading-relaxed text-2xl font-poppins">
                {item.description}
              </p>
            </div>
          </div>
